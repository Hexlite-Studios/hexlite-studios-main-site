    ...
    return (
        <div className="bg-zinc-950">
            <div className="bg-zinc-900/50">
                <div className="mx-auto flex justify-between gap-60">
                    <Link
                        to="/"
                        className="text-gray-200 hover:text-white transition-colors duration-200 flex items-center gap-1 mx-auto"
                    >
